  ...
  return (
    <section className='bg-secondary h-full  '>
      <div className='wrapper flex justify-between'>
        ...
        <div className='py-28 flex flex-col gap-8'>
          <SectionTitle text='I AM DESIGNER' />
          <h2 className='hero-heading'>Creative Design <br /> and Web Solutions</h2>
          <p className='paragraph-text '>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod <br /> maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus <br /> autem quibusdam et.</p>
