    ...
    return (
        <section id="contact" className="bg-secondary py-16 text-tertiary mt-10">
            <div className='wrapper'>
                ...
                <div className="flex lg:items-start justify-between lg:flex-row flex-col items-center gap-10">
                    <div className="w-full lg:w-2/3 mb-8 lg:mb-0">
                        <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input
                                type="text"
                                placeholder="Your Name"
                                className="border border-primary rounded-lg p-3 md:p-5 focus:outline-none focus:ring-2 focus:ring-primary"
                            />
                            <input
                                type="email"
